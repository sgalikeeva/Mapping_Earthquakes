...
let torontoHoods = "https://raw.githubusercontent.com/sgalikeeva/Mapping_Earthquakes/main/torontoNeighborhoods.json"
...
d3.json(torontoHoods).then(function(data) {
    ...
    L.geoJSON(data, {
      ...
      onEachFeature: function(feature, layer) {
        layer.bindPopup("<b>" + "Neighborhood: " + feature.properties.AREA_NAME +"</b>" )
      }
    }).addTo(map);
    });
